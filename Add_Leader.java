...
public class Add_Leader extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            conn con = new conn();
            if(ae.getSource() == b1){
                String sql = "insert into Leaders(Leader_id, name, icon) values(?, ?, ?)";
