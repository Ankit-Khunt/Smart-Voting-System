...
public class Leaders_Details extends JFrame implements ActionListener{
	...
	ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("OnlineVotingSystem/icons/eight.png"));
	...
	ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("OnlineVotingSystem/icons/nineth.png"));
	...
	ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("OnlineVotingSystem/icons/tenth.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                String sql = "select * from Leaders where concat(Leader_id, name) like ?";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		table.setModel(DbUtils.resultSetToTableModel(rs));
            ...
            if(ae.getSource() == b2){
                String sql = "delete from Leaders where name = '" + search.getText() + "'";
		PreparedStatement st = con.c.prepareStatement(sql);
